...
export default function FavoritesPage({ api, pageSize, onOpenFolder, onOpenFile, onToggleFavorite, onDeleteItem, selected, onToggleSelect }) {
    ...
    return (
        <main>
            ...
            <FileGrid items={items} selectedPaths={selected} onToggleSelect={onToggleSelect} onOpenFolder={onOpenFolder} onLongPressSelect={onToggleSelect} onOpenFile={onOpenFile} onToggleFavorite={toggleFavorite} onDeleteItem={onDeleteItem} pageSize={pageSize} />
        </main>
    );
}